...
export function Header() {
  ...
  const title = pathname.startsWith("/admin/profile") ? "My Profile" : pathname.startsWith("/admin/customers") ? "Customers" : pathname.startsWith("/admin/products") ? "Products" : pathname.startsWith("/admin/orders") ? "Orders" : pathname.startsWith("/admin/categories") ? "Categories" : pathname.startsWith("/admin/addresses") ? "Addresses" : pathname.startsWith("/admin/settings") ? "Settings" : "Dashboard";
