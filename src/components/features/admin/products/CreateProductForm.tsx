...
import type { ApiResponse, Category, ImageUploadResponse, ProductRequest } from "@/types/product";
...
export function CreateProductForm() {
  ...
  async function handleSubmit(event: React.FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      const createdPayload = "payload" in createResult && createResult.payload && typeof createResult.payload === "object" ? createResult.payload as { productId?: unknown } : null;
      await createNotification({
        // Backend NotificationType enum has no PRODUCT_CREATED yet; ORDER_CREATED is used as a valid placeholder.
        type: "ORDER_CREATED",
        title: "Product created",
        message: `${product.productName} was added to the catalog.`,
        referenceId: typeof createdPayload?.productId === "number" ? createdPayload.productId : undefined,
