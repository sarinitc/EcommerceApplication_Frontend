...
import type { ApiResponse, ImageUploadResponse, Product, ProductRequest } from "@/types/product";
  ...
  async function saveProduct(event: React.FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      await createNotification({
        // Backend NotificationType enum has no PRODUCT_UPDATED yet; ORDER_UPDATED is used as a valid placeholder.
        type: "ORDER_UPDATED",
        title: "Product updated",
        message: `${request.productName} was updated to ${currency.format(specialPrice)}.`,
